...
> Aplicación web que consume los servicios privados de la API Web security app.
...
> 1. Clonar el repositorio: git clone https://github.com/dpdorado/web_security_app
> 2. En el directorio web_security_app instalamos las depencias del proyecto con: npm install
> 3. Corremos el proyecto con: npm run serve


# Pendientes

> * En el directorio web_security_app está la apliación principal.
> * La plantilla admin ya esta instalada.
> * Queda pendiente instalar la plantilla de inicio ubicada en el directorio plantilla_inicio en la app principal.


## By Daniel Dorado, Bladimir, Miguel Calambas
