                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="invoice p-5">
                            <h5>Tu orden esta completada!</h5> <span class="font-weight-bold d-block mt-4">Hello, Chris</span> <span>You order has been confirmed and will be shipped in next two days!</span>
